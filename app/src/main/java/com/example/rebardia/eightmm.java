...
public class eightmm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_eightmm);
    ...
    private void calculateWeight() {
        ...
        for (int i = 0; i < editTextsList.size(); i += 3) {
            try {
                ...
                double final_cutLength = Math.ceil(2 * (length + width) * 25.4 + 2 * 80 - 7.4 * 8 + 1);
                double perMeterWeight = (8 * 8) / 162.2;
